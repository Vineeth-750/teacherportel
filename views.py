...
def add_student(request):
    ...
    if request.method == 'POST':
        ...
        if not roll_number:
            ...
            error_field['roll_number'] = 'This roll number already exists.'
        if not subject:
            error_field['subject'] = 'Subject is required.'
        if not exam_name:
            error_field['exam_name'] = 'Exam name is required.'
        try:
...
def update_student(request, student_id):
    ...
    try:
        mark = Mark.objects.get(student=student, entered_by=teacher)
...
def delete_student(request, student_id):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            response_data.update({
                'status': 'success',
                'message': 'Student and mark deleted successfully.'
            })
        except Mark.DoesNotExist:
            response_data['message'] = 'Mark not found or unauthorized.'
